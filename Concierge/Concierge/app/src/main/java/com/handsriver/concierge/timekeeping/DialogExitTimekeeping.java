...
import com.handsriver.concierge.database.updatesTables.UpdateTimekeeping;
...
public class DialogExitTimekeeping extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.messageExitPorter);
        ...
        exit = df.format(calendar.getTime());
        ...
        if (c != null){
            while (c.moveToNext()){
                ...
                if (rut.equals(rutFormat)){
                    ...
                    porterId = c.getString(c.getColumnIndex(PorterEntry.COLUMN_PORTER_ID_SERVER));
                }
            }
            c.close();
        }
        ...
        builder.setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                UpdateTimekeeping exitTimekeeping = new UpdateTimekeeping(Utility.changeDateFormatDatabase(exit),porterId,porterIdServer,getContext());
                exitTimekeeping.execute();
