...
public class SearchSuppliersFragment extends Fragment {
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_search_suppliers, container, false);
        linearLayout = (LinearLayout) rootView.findViewById(R.id.linearSearchSuppliers);
