...
import com.handsriver.concierge.database.updatesTables.UpdateExitCommonspacesVisit;
...
public class DialogExitCommonspacesvisitsRegister extends DialogFragment {
    String Idvisit;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Idvisit = getArguments().getString("visitId");

        builder.setTitle(R.string.confirmInfo);
        builder.setMessage(R.string.markExitCommonspaceQuestion)
                .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        UpdateExitCommonspacesVisit updateCommonspaceVisits = new UpdateExitCommonspacesVisit(exit,porterIdServer,Idvisit,getContext());
                        updateCommonspaceVisits.execute();
