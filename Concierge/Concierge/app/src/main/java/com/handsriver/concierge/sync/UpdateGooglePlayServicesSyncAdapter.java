...
public class UpdateGooglePlayServicesSyncAdapter extends AbstractThreadedSyncAdapter {

    public UpdateGooglePlayServicesSyncAdapter(Context context, boolean autoInitialize) {
